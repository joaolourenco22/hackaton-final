...
app.post('/api/seed', async (req, res) => {
  try {
    ...
    let sample = [
      { name: 'Ana Silva', role: 'Frontend Developer', location: 'Coimbra', years_experience: 3, tags: ['react', 'ui', 'css'], hard_score: 92, soft_skills: { communication: 78, teamwork: 62, problem_solving: 69, adaptability: 74, leadership: 50, creativity: 88 } },
      { name: 'Bruno Costa', role: 'Backend Developer', location: 'Braga', years_experience: 5, tags: ['node', 'api', 'docker'], hard_score: 86, soft_skills: { communication: 55, teamwork: 72, problem_solving: 93, adaptability: 60, leadership: 62, creativity: 48 } },
      ...
      { name: 'Eduarda Lopes', role: 'Product Manager', location: 'Aveiro', years_experience: 7, tags: ['roadmap', 'stakeholders'], hard_score: 68, soft_skills: { communication: 96, teamwork: 92, problem_solving: 74, adaptability: 86, leadership: 90, creativity: 85 } },
      { name: 'Fernando Alves', role: 'Fullstack Developer', location: 'Aveiro', years_experience: 4, tags: ['node', 'react', 'sql'], hard_score: 74, soft_skills: { communication: 61, teamwork: 70, problem_solving: 76, adaptability: 58, leadership: 42, creativity: 55 } },
      { name: 'Gabriela Dias', role: 'UX Designer', location: 'Coimbra', years_experience: 5, tags: ['ux', 'research', 'figma'], hard_score: 62, soft_skills: { communication: 94, teamwork: 88, problem_solving: 60, adaptability: 84, leadership: 48, creativity: 98 } },
      { name: 'Henrique Souza', role: 'Mobile Developer', location: 'Braga', years_experience: 3, tags: ['react-native', 'ios', 'android'], hard_score: 79, soft_skills: { communication: 66, teamwork: 74, problem_solving: 82, adaptability: 70, leadership: 53, creativity: 69 } },
      ...
      { name: 'Karen Martins', role: 'Data Engineer', location: 'Coimbra', years_experience: 5, tags: ['etl', 'spark', 'cloud'], hard_score: 88, soft_skills: { communication: 64, teamwork: 72, problem_solving: 86, adaptability: 78, leadership: 61, creativity: 57 } },
      { name: 'Lucas Moreira', role: 'Frontend Developer', location: 'Aveiro', years_experience: 2, tags: ['js', 'react', 'html'], hard_score: 67, soft_skills: { communication: 80, teamwork: 68, problem_solving: 54, adaptability: 66, leadership: 40, creativity: 82 } },
      ...
      { name: 'Olivia Santos', role: 'Data Scientist', location: 'Braga', years_experience: 3, tags: ['ml', 'nlp'], hard_score: 93, soft_skills: { communication: 72, teamwork: 60, problem_solving: 95, adaptability: 69, leadership: 48, creativity: 76 } },
      { name: 'Paulo Henrique', role: 'DevOps Engineer', location: 'Coimbra', years_experience: 7, tags: ['k8s', 'terraform', 'observability'], hard_score: 81, soft_skills: { communication: 60, teamwork: 78, problem_solving: 85, adaptability: 91, leadership: 76, creativity: 55 } },
      { name: 'Queila Barros', role: 'Scrum Master', location: 'Aveiro', years_experience: 8, tags: ['agile', 'scrum'], hard_score: 63, soft_skills: { communication: 98, teamwork: 95, problem_solving: 58, adaptability: 94, leadership: 92, creativity: 66 } },
      ...
      { name: 'Tiago Vieira', role: 'Mobile Developer', location: 'Aveiro', years_experience: 3, tags: ['android', 'kotlin'], hard_score: 82, soft_skills: { communication: 68, teamwork: 72, problem_solving: 86, adaptability: 62, leadership: 55, creativity: 59 } },
    ];
